...
class anyNameWillBeValid extends StatelessWidget {
  @override
  Widget build(BuildContext context) { // responsible for all UI
      return MaterialApp (
        home : AnotherPage(),
      );
  }
  ...
  Widget build (BuildContext context) {
    return Scaffold(
      ...
      style: TextStyle(color: Colors.redAccent,
        ...
        shadows: [Shadow (color: Colors.deepPurple, blurRadius: 15.7, offset: Offset(40, 25))],
      ...
      textDirection: TextDirection.rtl // el klam da lma nkoon bnktb 3rby baa  ,
      ),
      appBar: AppBar(),
      drawer: Drawer(),
    );
    ...
    return Scaffold(
      ...
      body: Text("Whats Up bro x",
        style: TextStyle(
            ...
            decoration: TextDecoration.lineThrough, //  de bt7ot 5at fe nos el klam zy lama ykon fe sale keda w 3auz tshtob 3la el adem w t7ot el gded
